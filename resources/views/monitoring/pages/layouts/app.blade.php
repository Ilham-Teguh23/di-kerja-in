...
<head>
  ...
  ============================================ -->
    ...
    @include("monitoring.pages.layouts.components.css.style-css")
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html">
                    <img class="main-logo" src="{{ url('') }}/img/logo/logo.png" alt="" /></a>
                <strong>
                    <a href="index.html">
                    <img src="{{ url('') }}/img/logo/logosn.png" alt="" /></a></strong>
            </div>

            @include("monitoring.pages.layouts.components.sidebar.v_sidebar")
    ...
    <div class="all-content-wrapper">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right sp-cn-r"><i class="fa fa-level-up" aria-hidden="true"></i>
                                    <span class="counter text-success"><span class="counter">1500</span></span>
                                </li>
                            </ul>
                        </div>
                        <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n">
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right graph-two-ctn"><i class="fa fa-level-up"
                                        aria-hidden="true"></i> <span class="counter text-purple"><span
                                            class="counter">3000</span></span>
                                </li>
                            </ul>
                        </div>
                        <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n">
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right graph-three-ctn"><i class="fa fa-level-up"
                                        aria-hidden="true"></i> <span class="counter text-info"><span
                                            class="counter">5000</span></span>
                                </li>
                            </ul>
                        </div>
        ...
        @include("monitoring.pages.layouts.components.footer.v_footer")

    </div>

    @include("monitoring.pages.layouts.components.js.style-js")
