...
<head>
    ...
    @include("landing-page.layouts.css.style-css")
...
<body class="index-page">
        ...
        <section id="hero" class="hero section">
            ...
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <img src="{{ url('landing-page') }}/assets/img/hero-services-img.webp" class="img-fluid hero-img" alt=""
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            <div class="col-lg-6">
                                <img src="{{ url('landing-page') }}/assets/img/about-company-1.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="row gy-4">
                                    <div class="col-lg-12">
                                        <img src="{{ url('landing-page') }}/assets/img/about-company-2.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="col-lg-12">
                                        <img src="{{ url('landing-page') }}/assets/img/about-company-3.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ url('landing-page') }}/assets/img/clients/client-1.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ url('landing-page') }}/assets/img/clients/client-2.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ url('landing-page') }}/assets/img/clients/client-3.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ url('landing-page') }}/assets/img/clients/client-4.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ url('landing-page') }}/assets/img/clients/client-5.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="{{ url('landing-page') }}/assets/img/clients/client-6.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="tab-pane fade active show" id="features-tab-1">
                                <img src="{{ url('landing-page') }}/assets/img/tabs-1.jpg" alt="" class="img-fluid">
                            </div><!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-2">
                                <img src="{{ url('landing-page') }}/assets/img/tabs-2.jpg" alt="" class="img-fluid">
                            </div><!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-3">
                                <img src="{{ url('landing-page') }}/assets/img/tabs-3.jpg" alt="" class="img-fluid">
                            </div><!-- End Tab Content Item -->
                        </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ url('landing-page') }}/assets/img/features-1.jpg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="order-1 col-lg-6 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{ url('landing-page') }}/assets/img/features-2.jpg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="order-2 col-lg-6 d-flex flex-column justify-content-center order-lg-1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 icon-box d-flex">
                                <i class="flex-shrink-0 bi bi-brightness-high"></i>
                                <div>
                                    <h4>Dine Pad</h4>
                    ...
                    <div class="order-1 features-image col-lg-5 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{ url('landing-page') }}/assets/img/features-3.jpg" alt="">
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ url('landing-page') }}/assets/img/testimonials/testimonials-1.jpg" class="testimonial-img"
                                        alt="">
                                    <h3>Saul Goodman</h3>
                                    <h4>Ceo &amp; Founder</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ url('landing-page') }}/assets/img/testimonials/testimonials-2.jpg" class="testimonial-img"
                                        alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ url('landing-page') }}/assets/img/testimonials/testimonials-3.jpg" class="testimonial-img"
                                        alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ url('landing-page') }}/assets/img/testimonials/testimonials-4.jpg" class="testimonial-img"
                                        alt="">
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ url('landing-page') }}/assets/img/testimonials/testimonials-5.jpg" class="testimonial-img"
                                        alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                </div>
    ...
    @include("landing-page.layouts.js.style-js")
